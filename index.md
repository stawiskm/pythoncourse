...
- **[Assignment 1: Python Basics](Assignments/Py01-Assignments.md)** - Variables, functions, and control flow
- **[Assignment 2: Arrays](Assignments/Py02-Assignments.md)** - List operations and array manipulation
  - [📓 Interactive Notebook](https://colab.research.google.com/github/stawiskm/pythoncourse/blob/student/Assignments/Py02-Assignments.ipynb)
- **[Assignment 3: Pandas](Assignments/Py03-Assignments.md)** - Data analysis with Pandas
  - [📓 Interactive Notebook](https://colab.research.google.com/github/stawiskm/pythoncourse/blob/student/Assignments/Py03-Assignments.ipynb)
- **[Assignment 4: Visualization](Assignments/Py04-Assignments.md)** - Creating meaningful visualizations
  - [📓 Interactive Notebook](https://colab.research.google.com/github/stawiskm/pythoncourse/blob/student/Assignments/Py04-Assignments.ipynb)
...
- [All Beginner Exercises](Coding/Level%200%20(Beginner)/)

### 🟡 Easy Level  
For those with basic Python understanding.
- [All Easy Exercises](Coding/Level%201%20(Easy)/)

### 🟠 Medium Level
Intermediate challenges to strengthen your skills.
- [All Medium Exercises](Coding/Level%202%20(Medium)/)

### 🔴 Hard Level
Advanced problems for experienced programmers.
- [All Hard Exercises](Coding/Level%203%20(Hard)/)
...
- [The 10 Golden Rules of Data Visualization](The_10_Golden_Rules_of_Data_Visualization.mp4)
...
```
pythoncourse/
├── 📚 Lecture_Notes/     # Theory and concepts with videos
├── 💻 Coding/            # Interactive exercises by difficulty
...
- **[GitHub Repository](https://github.com/stawiskm/pythoncourse)**

## 💡 Tips for Success

1. **Watch videos first** - Get an overview of concepts
2. **Read lecture notes** - Understand the details
3. **Practice immediately** - Open Colab notebooks and code along
4. **Complete assignments** - Reinforce your learning
5. **Progress gradually** - Start with your level and work up
6. **Ask questions** - Learning is a journey, not a race

---

## 🎓 About This Course

This Python course is designed for learners at all levels, from complete beginners to experienced programmers looking to expand their Python skills. All materials are freely available and can be accessed directly in your browser through Google Colab - no installation required!
...
Start your Python journey today! Choose a module above and begin learning.
